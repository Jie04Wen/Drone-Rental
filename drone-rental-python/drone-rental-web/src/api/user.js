...
export const uploadCertificate = (file) => {
    return upload('/common/upload?category=qualification', file, 'file')
}

export const uploadAvatar = (file) => {
    return upload('/common/upload?category=avatar', file, 'file')
}
...
export const getQualificationCertificateUrl = () => {
    return get('/user/qualification/certificate-url')
}

export const getAvatarUrl = () => {
    return get('/user/avatar-url')
}
...
// 获取当前用户诚信记录
export const getMyCreditRecords = () => {
    return get('/user/credit-records')
}
