...
export const uploadFaultImage = (file) => {
    return upload('/common/upload?category=fault', file, 'file')
}
...
export const getFaultImageUrls = (id) => {
    return get(`/fault/${id}/image-urls`)
}
...
export const getAdminFaultImageUrls = (id) => {
    return get(`/admin/maintenance/fault/${id}/image-urls`)
}
